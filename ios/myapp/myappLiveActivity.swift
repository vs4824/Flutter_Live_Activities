...
struct myappLiveActivity_Previews: PreviewProvider {
    static let attributes = myappAttributes(name: "Me")
    static let contentState = myappAttributes.ContentState(value: 3)
